...
[![JOSS](https://img.shields.io/static/v1?label=+&logo=pdf&color=gray&message=JOSS+under+review)](https://github.com/openjournals/joss-reviews/issues/4412) PySDM v2 outline paper    
...
[![arXiv](https://img.shields.io/static/v1?label=+&logo=arxiv&color=gray&message=2011.14726)](https://arxiv.org/abs/2011.14726) [Michael Olesik's](https://github.com/rlhycd) paper on an application of PyMPDATA in bin microphysics ([published in GMD](https://doi.org/10.5194/gmd-15-3879-2022))   
