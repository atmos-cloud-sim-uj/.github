...
Note for candidates holding a PhD degree obtained from an institution based outside of European Union, in a country that is not a member of Organisation for Economic Co-operation and Development (OECD) or European Free Trade Association (EFTA) and not covered by any other international agreement on degree equivalence. Upon selection for employment, the candidate will be required to obtain [Polish nostrification of the PhD degree](https://nawa.gov.pl/images/users/642/Nostrification-of-higher-education-diplomas.pdf).
...
Application procedure (deadline: April 3rd 2022) is detailed in the [official advertisement on the institute website](https://matinf.uj.edu.pl/en_GB/konkursy/-/journal_content/56_INSTANCE_SaA7HRzna0dW/41633/150056744) (scroll there down for a link to pdf in English) and includes submission of CV, brief statement of research, pointers to contributions to public code repositories, and two reference letters.
...
#### Our Python packages (with usage examples for Julia & Matlab):
PySDM:
  ...
  [![PySDM docs](https://img.shields.io/badge/PySDM_docs-pdoc3-blue.svg)](https://atmos-cloud-sim-uj.github.io/PySDM/)   
PySDM-examples:
  [![PyPI version](https://badge.fury.io/py/PySDM-examples.svg)](https://pypi.org/project/PySDM-examples)
  [![PySDM-exampels docs](https://img.shields.io/badge/PySDM_examples_docs-pdoc3-blue.svg)](https://atmos-cloud-sim-uj.github.io/PySDM-examples/)   
PyMPDATA:
  ...
  [![PyMPDATA docs](https://img.shields.io/badge/PyMPDATA_docs-pdoc3-blue.svg)](https://atmos-cloud-sim-uj.github.io/PyMPDATA/)   
PyMPDATA-examples:
  [![PyPI version](https://badge.fury.io/py/PyMPDATA-examples.svg)](https://pypi.org/project/PyMPDATA-examples)
  [![PyMPDATA-exampels docs](https://img.shields.io/badge/PyMPDATA_examples_docs-pdoc3-blue.svg)](https://atmos-cloud-sim-uj.github.io/PyMPDATA-examples/)   
numba-mpi:
